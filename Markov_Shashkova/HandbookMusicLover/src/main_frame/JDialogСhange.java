 ...
 * @author константин
 */
public class JDialogСhange extends javax.swing.JDialog {

/**
 * Creates new form JDialogСhange
 */
public JDialogСhange(java.awt.Frame parent, boolean modal,ArrayList<MusicalRecording> music, ArrayList<MusicIndustryWorker> people) {
    super(parent, modal);
    initComponents();
    this.music=music;
    this.people=people;
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("JDialogСhange.title")); // NOI18N
        ...
        jButtonExit.setText(bundle.getString("JDialogСhange.jButtonExit.text")); // NOI18N
        jButtonExit.setToolTipText(bundle.getString("JDialogСhange.jButtonExit.toolTipText")); // NOI18N
        ...
        jFormattedTextFieldSearchName.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(51, 51, 51), new java.awt.Color(51, 51, 51)), bundle.getString("JDialogСhange.jFormattedTextFieldSearchName.border.title"), javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.ABOVE_TOP)); // NOI18N
        try {
        ...
        jButtonChange.setText(bundle.getString("JDialogСhange.jButtonChange.text")); // NOI18N
        jButtonChange.setToolTipText(bundle.getString("JDialogСhange.jButtonChange.toolTipText")); // NOI18N
        jButtonChange.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(51, 51, 51), new java.awt.Color(102, 102, 102)));
        ...
        jButtonChange.setBounds(800, 230, 160, 50);
    ...
    private class FormListener implements java.awt.event.ActionListener, java.awt.event.KeyListener, java.awt.event.MouseListener, java.awt.event.WindowListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == jButtonExit) {
                JDialogСhange.this.jButtonExitActionPerformed(evt);
            }
            else if (evt.getSource() == jButtonChange) {
                JDialogСhange.this.jButtonChangeActionPerformed(evt);
            }
        }
        ...
        public void keyReleased(java.awt.event.KeyEvent evt) {
            if (evt.getSource() == jFormattedTextFieldSearchName) {
                JDialogСhange.this.jFormattedTextFieldSearchNameKeyReleased(evt);
            }
        }
        ...
        public void mouseClicked(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == jTableMusic) {
                JDialogСhange.this.jTableMusicMouseClicked(evt);
            }
        }

        public void mouseEntered(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == jButtonExit) {
                JDialogСhange.this.jButtonExitMouseEntered(evt);
            }
            else if (evt.getSource() == jButtonChange) {
                JDialogСhange.this.jButtonChangeMouseEntered(evt);
            }
        }

        public void mouseExited(java.awt.event.MouseEvent evt) {
            if (evt.getSource() == jButtonExit) {
                JDialogСhange.this.jButtonExitMouseExited(evt);
            }
            else if (evt.getSource() == jButtonChange) {
                JDialogСhange.this.jButtonChangeMouseExited(evt);
            }
        }
        ...
        public void windowOpened(java.awt.event.WindowEvent evt) {
            if (evt.getSource() == JDialogСhange.this) {
                JDialogСhange.this.formWindowOpened(evt);
            }
        }
...
protected String russificationGenre(String str)
{
    ...
    private void jButtonChangeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonChangeMouseExited
        // TODO add your handling code here:
        this.jButtonChange.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(51, 51, 51), new java.awt.Color(51, 51, 51)));
    }//GEN-LAST:event_jButtonChangeMouseExited

    private void jButtonChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonChangeActionPerformed
        // TODO add your handling code here:
         int i=this.jTableMusic.getSelectedRow();
         new JDialogAdd((Frame) this.getParent(),true,this.music.get(i),this.people).setVisible(true);
        String[] str=new String[3]; 
        DefaultTableModel table=(DefaultTableModel) this.jTableMusic.getModel();
        str[0]=this.music.get(i).getSong().getName();
        str[1]=this.russificationGenre(this.music.get(i).getSong().getGenre());
        if(new DateCompare().compare(this.music.get(i).getSong().getCreationDate(), "1.1.1")!=0)
            str[2]=this.music.get(i).getSong().getCreationDate();
        table.removeRow(i);
        table.insertRow(i, str);
        this.jTableMusic.setRowSelectionInterval(i, i);
    }//GEN-LAST:event_jButtonChangeActionPerformed

    private void jTableMusicMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMusicMouseClicked
        // TODO add your handling code here:
         if(jTableMusic.getSelectedRow()!=-1&&this.jButtonChange.isEnabled()==false)
            this.jButtonChange.setEnabled(true); 
